...
const Playground = ({
  ...
  return (
    ...
    >
      ...
      {headerPosition === 'top' && <Header currentSubjectName={currentSubjectName} siteName={siteName} headerPosition={headerPosition} headerAnimationEffect={headerAnimationEffect} className="mb-1 md:mb-2"/>}
      ...
      {headerPosition === 'bottom' && <Header currentSubjectName={currentSubjectName} siteName={siteName} headerPosition={headerPosition} headerAnimationEffect={headerAnimationEffect} className="mt-1 md:mt-2"/>}
